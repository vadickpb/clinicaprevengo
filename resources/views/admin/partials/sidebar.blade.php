       ...
       with font-awesome or any other icon font library -->
                ...
                <li class="nav-item {{ openMenu(['admin/users', 'admin/users/create']) }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('users.create') }}" class="nav-link {{ activeMenu(['admin/users/create']) }}">
                ...
                <li class="nav-item {{ openMenu(['admin/pacientes', 'admin/pacientes/create']) }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('pacientes.index') }}" class="nav-link {{ activeMenu(['admin/pacientes']) }}">
                                <i class="far fa-eye nav-icon"></i>
                                <p>Mostrar pacientes</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('pacientes.create') }}" class="nav-link {{ activeMenu(['admin/pacientes/create']) }}">
                                <i class="fas fa-pen nav-icon"></i>
